...
$output .= get_template('container', array('content' => $einstell_list, 'height' => '45%', 'min-height' => '50px', 'max-height' => DEFAULT_CONTAINER_MAX_HEIGHT,'border' => DEFAULT_CONTAINER_BORDER, 'id' => DEFAULT_CONTAINER_ID));
$output .= '<b>Messwerte:</b></br>';
$output .= get_template('container', array('content' => $mess_list, 'height' => '10%', 'min-height' => '50px', 'max-height' => DEFAULT_CONTAINER_MAX_HEIGHT,'border' => DEFAULT_CONTAINER_BORDER, 'id' => DEFAULT_CONTAINER_ID));
